...
public class CrystalStatementsImpl extends ASTWrapperPsiElement implements CrystalStatements {

  public CrystalStatementsImpl(ASTNode node) {
    super(node);
  }
  ...
  public CrystalStatement getStatement() {
    return findNotNullChildByClass(CrystalStatement.class);
  }
